...
class Gaussian():
    ...
    def calculate_mean(self):
        ...
        for elements in self.data:
            total_sum+=elements
        self.mean = total_sum / len(self.data)
    ...
    def pdf(self, x):
        ...
        stddev = self.calculate_stdev()
        PDF = (1 / math.sqrt(2 * math.pi.math.pow(stddev,2)) )* (math.exp(-0.5 * (math.pow(x - self.calculate_mean(),2) / 2 * stddev**2)))
        return PDF
        pass        
